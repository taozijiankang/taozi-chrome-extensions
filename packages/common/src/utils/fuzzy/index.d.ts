 ...
 */
export declare function simpleFilter(pattern: string, array: string[]): string[];
 ...
 */
export declare function match(pattern: string, inputString: string, opts?: MatchOptions): MatchResult;
 ...
 */
export declare function filter<T>(pattern: string, arr: T[], opts?: FilterOptions<T>): FilterResult<T>[];
