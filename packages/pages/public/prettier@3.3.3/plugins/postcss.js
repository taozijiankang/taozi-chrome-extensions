  ...
  var y = (t, e) => () => (e || t((e = { exports: {} }).exports, e), e.exports),
    ...
    Xs = (t, e, s, r) => {
      if ((e && typeof e == "object") || typeof e == "function")
        for (let n of ll(e))
          !fl.call(t, n) && n !== s && bt(t, n, { get: () => e[n], enumerable: !(r = ul(e, n)) || r.enumerable });
      return t;
    };
  var ye = (t, e, s) => (
      (s = t != null ? al(cl(t)) : {}),
      Xs(e || !t || !t.__esModule ? bt(s, "default", { value: t, enumerable: !0 }) : s, t)
    ),
          ...
          (super(e),
            ...
            typeof s < "u" &&
              ...
              (typeof s == "number"
                ...
                : ((this.line = s.line), (this.column = s.column), (this.endLine = r.line), (this.endColumn = r.column))),
            this.setMessage(),
        ...
        return {
          ...
          set(e, s, r) {
            return (
              e[s] === r ||
                ((e[s] = r),
                (s === "prop" || s === "value" || s === "name" || s === "params" || s === "important" || s === "text") &&
                  e.markDirty()),
              !0
            );
          }
...
`
      ...
      rangeBy(e) {
        ...
        if (e.word) {
          ...
          (e.start ? (s = { column: e.start.column, line: e.start.line }) : e.index && (s = this.positionInside(e.index)),
            e.end
        ...
        return (
          (r.line < s.line || (r.line === s.line && r.column <= s.column)) && (r = { column: s.column + 1, line: s.line }),
          { end: r, start: s }
        );
      }
      raw(e, s) {
  ...
  var lt = y((cv, Ei) => {
    ...
    var mc = at(),
      ut = class extends mc {
        constructor(e) {
          (e && typeof e.value < "u" && typeof e.value != "string" && (e = { ...e, value: String(e.value) }),
            super(e),
            (this.type = "decl"));
        }
        get variable() {
  ...
  var re = y((pv, qi) => {
    ...
    var Y = class t extends wc {
      ...
      each(e) {
        ...
        for (
          ;
          this.indexes[s] < this.proxyOf.nodes.length && ((r = this.indexes[s]), (n = e(this.proxyOf.nodes[r], r)), n !== !1);
        )
          this.indexes[s] += 1;
            ...
            return s === "proxyOf"
              ...
              : e[s]
                ? s === "each" || (typeof s == "string" && s.startsWith("walk"))
                  ? (...r) => e[s](...r.map(n => (typeof n == "function" ? (i, o) => n(i.toProxy(), o) : n)))
                  : s === "every" || s === "some"
      ...
      normalize(e, s) {
        ...
        return e.map(
          n => (
            ...
            n[Ti] && Ii(n),
            typeof n.raws.before > "u" && s && typeof s.raws.before < "u" && (n.raws.before = s.raws.before.replace(/\S/g, "")),
        ...
        switch (((i = r.charCodeAt(d)), i)) {
          ...
          case 40: {
            if (
              ((l = m.length ? m.pop()[1] : ""),
              (w = r.charCodeAt(d + 1)),
              l === "url" && w !== 39 && w !== 34 && w !== 32 && w !== 10 && w !== 9 && w !== 12 && w !== 13)
            ) {
              o = d;
              do {
              ...
              ((o = r.indexOf(")", d + 1)),
                (u = r.slice(d, o + 1)),
                o === -1 || gc.test(u) ? (x = ["(", "(", d]) : ((x = ["brackets", u, d, o]), (d = o)));
            break;
          }
          case 39:
          case 34: {
          ...
          case 92: {
            ...
            if (
              ((i = r.charCodeAt(o + 1)),
              c && i !== 47 && i !== 32 && i !== 10 && i !== 9 && i !== 13 && i !== 12 && ((o += 1), Li.test(r.charAt(o))))
            ) {
    ...
    var Ui = re(),
      ...
      se = class extends Ui {
        ...
        removeChild(e, s) {
          let r = this.index(e);
          return (
            !s && r === 0 && this.nodes.length > 1 && (this.nodes[1].raws.before = this.nodes[r].raws.before),
            super.removeChild(e)
          );
        }
        toResult(e = {}) {
    ...
    var ls = class {
      ...
      colon(e) {
        ...
        for (let [o, a] of e.entries()) {
          if (((r = a), (n = r[0]), n === "(" && (s += 1), n === ")" && (s -= 1), s === 0 && n === ":"))
      ...
      decl(e, s) {
        ...
        (e.some(c => c[0] !== "space" && c[0] !== "comment") && ((r.raws.between += o.map(c => c[1]).join("")), (o = [])),
            ...
            o === "space" && l === a - 1 && !n
              ...
              : o === "comment"
                ? ((p = r[l - 1] ? r[l - 1][0] : "empty"),
                  ...
                  !ji[p] && !ji[f] ? (u.slice(-1) === "," ? (c = !1) : (u += i[1])) : (c = !1))
                : (u += i[1]));
        if (!c) {
      ...
      Pe = class {
        constructor(e, s = {}) {
          ...
          if (
            ...
            this.css[0] === "\uFEFF" || this.css[0] === "\uFFFE"
              ...
              : (this.hasBOM = !1),
            s.from && (!to || /^\w+:\/\//.test(s.from) || hs(s.from) ? (this.file = s.from) : (this.file = ds(s.from))),
            to && Ic)
          ) {
        ...
        error(e, s, r, n = {}) {
          ...
          return (
            ...
            (i.input = { column: r, endColumn: a, endLine: o, line: s, source: this.css }),
            this.file && (Qt && (i.input.url = Qt(this.file).toString()), (i.input.file = this.file)),
            i
          );
        }
        fromOffset(e) {
...
`)
    ...
    vo.exports = class extends Jc {
      atrule(e, s) {
        ...
        let n = `${e.function ? "" : e.raws.identifier || "@"}${e.name}`,
          ...
          o = e.raws.important || "";
        if ((e.variable && (i = e.value), typeof e.raws.afterName < "u" ? (n += e.raws.afterName) : i && (n += " "), e.nodes))
          this.block(e, n + i + o);
        else {
  ...
  var _s = y((Yv, Io) => {
    ...
    var { isClean: j, my: sf } = Ft(),
      ...
      lf = pt(),
      cf = Ae(),
      ff = { atrule: "AtRule", comment: "Comment", decl: "Declaration", document: "Document", root: "Root", rule: "Rule" },
      pf = {
        AtRule: !0,
        AtRuleExit: !0,
        Comment: !0,
      ...
      ne = class t {
        constructor(e, s, r) {
          ...
          if (typeof s == "object" && s !== null && (s.type === "root" || s.type === "document")) n = xs(s);
            ...
            ((n = xs(s.root)),
              s.map && (typeof r.map > "u" && (r.map = {}), r.map.inline || (r.map.inline = !1), (r.map.prev = s.map)));
          else {
            let i = lf;
        ...
        handleError(e, s) {
          ...
          try {
            (s && s.addToError(e),
              (this.error = e),
              e.name === "CssSyntaxError" && !e.plugin ? ((e.plugin = r.postcssPlugin), e.setMessage()) : r.postcssVersion);
          } catch (n) {
              ...
              for (let r in s) {
                ...
                if (!hf[r])
                  if (typeof s[r] == "object")
                    for (let n in s[r]) n === "*" ? e(s, r, s[r][n]) : e(s, r + "-" + n.toLowerCase(), s[r][n]);
        ...
        sync() {
          ...
          if ((this.prepareVisitors(), this.hasListener)) {
            ...
            if (this.listeners.OnceExit)
              if (e.type === "document") for (let s of e.nodes) this.visitSync(this.listeners.OnceExit, s);
        ...
        visitTick(e) {
          ...
          for (; s.eventIndex < i.length; ) {
            ...
            if (((s.eventIndex += 1), o === Ie)) {
              r.nodes && r.nodes.length && ((r[j] = !0), (s.iterator = r.getIterator()));
              return;
        ...
        switch (((i = r.charCodeAt(h)), i)) {
          ...
          case 40: {
            if (((p = d.length ? d.pop()[1] : ""), (l = r.charCodeAt(h + 1)), p === "url" && l !== 39 && l !== 34)) {
              ...
              ((o = r.indexOf(")", h + 1)),
                (u = r.slice(h, o + 1)),
                o === -1 || $f.test(u) ? (w = ["(", "(", h]) : ((w = ["brackets", u, h, o]), (h = o)));
            break;
          }
          case 39:
          case 34: {
            for (
              a = i, o = h, f = !1;
              o < x && (o++, o === x && v("string"), (i = r.charCodeAt(o)), (l = r.charCodeAt(o + 1)), !(!f && i === a));
            )
          ...
          case 92: {
            ...
            if (
              ((i = r.charCodeAt(o + 1)),
              c && i !== 47 && i !== 32 && i !== 10 && i !== 9 && i !== 13 && i !== 12 && ((o += 1), Ko.test(r.charAt(o))))
            ) {
          ...
          default:
            ((l = r.charCodeAt(h + 1)),
              i === 35 && l === 123
                ? ((o = h), F(), (u = r.slice(h, o + 1)), (w = ["word", u, h, o]), (h = o))
                : i === 47 && l === 42
                  ? ((o = r.indexOf("*/", h + 2) + 1),
...
`)
  ...
  var As = y(Cs => {
    ...
    function gt(t) {
      ...
      (this.constructor(t),
        (this.nodes = t.nodes),
        this.after === void 0 && (this.after = this.nodes.length > 0 ? this.nodes[this.nodes.length - 1].after : ""),
    ...
    gt.prototype.walk = function (e, s) {
      for (
        var r = typeof e == "string" || e instanceof RegExp, n = r ? s : e, i = typeof e == "string" ? new RegExp(e) : e, o = 0;
        o < this.nodes.length;
        o++
      ) {
        var a = this.nodes[o],
          u = r ? i.test(a.type) : !0;
        if ((u && n && n(a, o, this.nodes) === !1) || (a.nodes && a.walk(e, s) === !1)) return !1;
      }
      return !0;
    };
    gt.prototype.each = function () {
      for (
        var e = arguments.length <= 0 || arguments[0] === void 0 ? function () {} : arguments[0], s = 0;
        s < this.nodes.length;
        s++
      ) {
        var r = this.nodes[s];
  ...
  var aa = y(vt => {
        ...
        if (
          ((p === "'" || p === '"') &&
            (s[n].isCalculationEnabled === !0
              ...
              : s[n].mode === "string" && s[n].character === p && c[f - 1] !== "\\" && (s.pop(), n--)),
          p === "{" ? (s.push({ mode: "interpolation", isCalculationEnabled: !0 }), n++) : p === "}" && (s.pop(), n--),
          s[n].mode === "normal" && p === ":")
        ) {
          var l = c.substring(f + 1);
          ((a = { type: "value", before: /^(\s*)/.exec(l)[1], after: /(\s*)$/.exec(l)[1], value: l.trim() }),
            (a.sourceIndex = a.before.length + f + 1 + u),
            (o = { type: "colon", sourceIndex: f + u, after: a.before, value: ":" }));
          break;
        }
        i += p;
      }
      return (
        (i = { type: "media-feature", before: /^(\s*)/.exec(i)[1], after: /(\s*)$/.exec(i)[1], value: i.trim() }),
    ...
    function Ps(t) {
      ...
      for (var a = 0; a < t.length; a++) {
        var u = t[a];
        (n
          ? ((i.value += u), (u === "{" || u === "(") && r++, (u === ")" || u === "}") && r--)
          : u.search(/\s/) !== -1
            ? (i.before += u)
            : (u === "(" && ((i.type = "media-feature-expression"), r++), (i.value = u), (i.sourceIndex = e + a), (n = !0)),
          n &&
            r === 0 &&
            (u === ")" || a === t.length - 1 || t[a + 1].search(/\s/) !== -1) &&
            (["not", "only", "and"].indexOf(i.value) !== -1 && (i.type = "keyword"),
            i.type === "media-feature-expression" && (i.nodes = oa(i.value, i.sourceIndex)),
            s.push(Array.isArray(i.nodes) ? new Ns.default(i) : new na.default(i)),
            (i = o()),
            (n = !1)));
      }
        ...
        if (((i = s[c]), c > 0 && (s[c - 1].after = i.before), i.type === void 0)) {
          if (c > 0) {
            ...
            s[c - 1].type === "media-type" &&
              (s[c + 1]
                ? (i.type = s[c + 1].type === "media-feature-expression" ? "keyword" : "media-feature-expression")
                : (i.type = "media-feature-expression"));
          }
          if (c === 0) {
            if (!s[c + 1]) {
        ...
        (e.prototype.each = function (r) {
          ...
          if (((this.indexes[n] = 0), !!this.length)) {
            for (
              ...
              this.indexes[n] < this.length && ((i = this.indexes[n]), (o = r(this.at(i), i)), o !== !1);
            )
              this.indexes[n] += 1;
      ...
      for (
        ...
        switch (((r = s.charCodeAt(m)), r === xt && ((h = m), (d += 1)), r)) {
          ...
          case bd:
            ((i = r === za ? "'" : '"'), (n = m));
            do
              for (l = !1, n = s.indexOf(i, n + 1), n === -1 && b("quote", i), w = n; s.charCodeAt(w - 1) === Ms; )
                ((w -= 1), (l = !l));
            while (l);
          ...
          case Nd:
            ...
            break;
          case Ms:
            for (n = m, c = !0; s.charCodeAt(n + 1) === Ms; ) ((n += 1), (c = !c));
            ((r = s.charCodeAt(n + 1)),
              c && r !== Va && r !== Bs && r !== xt && r !== Fs && r !== $s && r !== Us && (n += 1),
...
`)),
                (a = o.length - 1),
                a > 0 ? ((f = d + a), (p = n - o[a].length)) : ((f = d), (p = h)),
    ...
    var dm = (function () {
      function t(e) {
        ...
        return (
          this.root.append(s),
          (this.current = s),
          this.lossy ? (this.tokens = (0, Za.default)({ safe: e.safe, css: e.css.trim() })) : (this.tokens = (0, Za.default)(e)),
          this.loop()
        );
      }
      return (
        (t.prototype.attribute = function () {
          ...
          var i = s.split(/((?:[*~^$|]?=))([^]*)/),
            ...
            a = {
              operator: i[1],
              value: i[2],
              source: { start: { line: n[2], column: n[3] }, end: { line: this.currToken[2], column: this.currToken[3] } },
              sourceIndex: n[4]
            };
          if (
            (o.length > 1
              ? (o[0] === "" && (o[0] = !0), (a.attribute = this.parseValue(o[2])), (a.namespace = this.parseNamespace(o[0])))
            ...
            ((r.value = this.lossy ? c : u[0]),
              u[1] && ((r.insensitive = !0), this.lossy || (r.raws.insensitive = u[1])),
              (r.quoted = c[0] === "'" || c[0] === '"'),
            ...
            (this.nextToken && this.nextToken[0] === "combinator"
              ...
              : this.prevToken && this.prevToken[0] === "combinator"
                ...
                : this.currToken[0] === "combinator"
                  ...
                  : this.currToken[0] === "space" && (s.value = this.parseSpace(this.currToken[1], " ")),
              this.position++);
        ...
        (t.prototype.pseudo = function () {
          for (var s = this, r = "", n = this.currToken; this.currToken && this.currToken[0] === ":"; )
          ...
          if (this.currToken[0] === "word") {
            ...
            this.splitWord(!1, function (o, a) {
              ((r += o),
                (i = new Xd.default({
                  value: r,
                  source: { start: { line: n[2], column: n[3] }, end: { line: s.currToken[4], column: s.currToken[5] } },
                  sourceIndex: n[4]
                })),
                s.newNode(i),
                a > 1 && s.nextToken && s.nextToken[0] === "(" && s.error("Misplaced parenthesis."));
            });
      ...
      Le = class extends _m {
        ...
        each(e) {
          ...
          if (((this.indexes[s] = 0), !!this.nodes)) {
            for (; this.indexes[s] < this.nodes.length && ((r = this.indexes[s]), (n = e(this.nodes[r], r)), n !== !1); )
              this.indexes[s] += 1;
            return (delete this.indexes[s], n);
          }
        }
    ...
    Bu.exports = function (e, s) {
      ...
      for (; u < i; ) {
        switch (((p = n.charCodeAt(u)), p === 10 && ((o = u), (a += 1)), p)) {
          ...
          case 40:
            (c++,
              (f = !f && c === 1 && r.length > 0 && r[r.length - 1][0] === "word" && r[r.length - 1][1] === "url"),
              r.push(["(", "(", a, u - o, a, l - o, u]));
            break;
          case 41:
          ...
          case 34:
            ((w = p === 39 ? "'" : '"'), (l = u));
            do
              for (v = !1, l = n.indexOf(w, l + 1), l === -1 && H("quote", w), R = l; n.charCodeAt(R - 1) === 92; )
                ((R -= 1), (v = !v));
            while (v);
...
`)),
                (h = x.length - 1),
                h > 0 ? ((b = a + h), (g = l - x[h].length)) : ((b = a), (g = o)),
                r.push(["comment", d, a, u - o, b, l - g, u]),
                (o = g),
                (a = b),
                (u = l));
            } else if (p === 35 && !zm.test(n.slice(u + 1, u + 2)))
              ((l = u + 1), r.push(["#", n.slice(u, l), a, u - o, a, l - o, u]), (u = l - 1));
              ...
              if (
                ...
                (C === 101 || C === 69) &&
                  ...
                  Qs >= 48 &&
                  Qs <= 57 &&
                  ((De.lastIndex = l + 2), De.test(n), De.lastIndex === 0 ? (l = n.length - 1) : (l = De.lastIndex - 2));
              }
                  ...
                  ? this.prevToken[0] !== "space" && this.prevToken[0] !== "("
                    ...
                    : this.nextToken[0] !== "space" && this.nextToken[0] !== "word"
                      ...
                      : this.nextToken[0] === "word" &&
                        ...
                        this.error("Syntax Error", this.currToken)
                  : (this.nextToken[0] === "space" || this.nextToken[0] === "operator" || this.prevToken[0] === "operator") &&
                    this.error("Syntax Error", this.currToken))),
            this.options.loose)
          ) {
            if (
        ...
        if (
          ...
          this.position !== this.tokens.length - 1 &&
            ...
            this.newNode(
              new Yu({
                value: o,
                source: { start: a, end: { line: this.currToken[4], column: this.currToken[5] } },
                sourceIndex: this.currToken[6]
              })
            ));
        }
          ...
          o.forEach((a, u) => {
            ...
            if (~i.indexOf(a))
              p = new Hm({
                value: f.slice(1),
                source: {
                  start: { line: this.currToken[2], column: this.currToken[3] + a },
              ...
              ((p = new (e && e[0] === "(" ? Xm : Yu)({
                ...
                p.type === "word"
                  ? ((p.isHex = /^#(.+)/.test(f)), (p.isColor = /^#([0-9a-f]{3}|[0-9a-f]{4}|[0-9a-f]{6}|[0-9a-f]{8})$/i.test(f)))
...
Expected it to be ${r}.`;
  ...
  function L(t, e = {}) {
    return (
      ...
      { type: ve, id: e.id, contents: t, break: !!e.shouldBreak, expandedStates: e.expandedStates }
    );
  }
  function tn(t) {
  ...
  function El(t, e) {
    let s = t.slice(1, -1),
      r =
        e.parser === "json" || e.parser === "jsonc" || (e.parser === "json5" && e.quoteProps === "preserve" && !e.singleQuote)
          ? '"'
  ...
  var _e = Sl;
  var Tl = new Set(["raw", "raws", "sourceIndex", "source", "before", "after", "trailingComma", "spaces"]);
  function un(t, e, s) {
    if (
    ...
    if (
      ...
      (t.type === "media-query" || t.type === "media-query-list" || t.type === "media-feature-expression") && delete e.value,
      ...
      (t.type === "media-feature" ||
        ...
        t.value &&
        (e.value = Ol(t.value)),
      t.type === "selector-combinator" && (e.value = _(!1, e.value, /\s+/gu, " ")),
      t.type === "media-feature" && (e.value = _(!1, e.value, " ", "")),
      ((t.type === "value-word" &&
        ((t.isColor && t.isHex) || ["initial", "inherit", "unset", "revert"].includes(t.value.toLowerCase()))) ||
        t.type === "media-feature" ||
      ...
      t.type === "selector-attribute" &&
        ...
        t.value && ((e.value = _(!1, e.value.trim(), /^["']|["']$/gu, "")), delete e.quoted)),
      (t.type === "media-value" ||
        t.type === "media-type" ||
        t.type === "value-number" ||
        t.type === "selector-root-invalid" ||
    ...
    if (
      ...
      r !== -1 &&
        ((e.groups[r].unit = ""), e.groups.splice(r + 1, 0, { type: "value-word", value: "...", isColor: !1, isHex: !1 }));
    }
    if (
      t.type === "value-comma_group" &&
      t.groups.some(
        r => (r.type === "value-atword" && r.value.endsWith("[")) || (r.type === "value-word" && r.value.startsWith("]"))
      )
    )
      return {
        type: "value-atword",
...
`,
  ...
  function wn(t, e) {
    var s, r, n;
    if (typeof ((r = (s = t.source) == null ? void 0 : s.start) == null ? void 0 : r.offset) == "number")
  ...
  function Vr(t, e) {
    ...
    if (typeof ((r = (s = t.source) == null ? void 0 : s.end) == null ? void 0 : r.offset) == "number")
  ...
  function Gr(t, e) {
    ...
    for (let s in t) {
      ...
      s === "source" ||
        !r ||
        typeof r != "object" ||
        (r.type === "value-root" || r.type === "value-unknown" ? gn(r, ql(t), r.text || r.value) : Gr(r, e));
    }
  }
  function gn(t, e, s) {
  ...
  function ql(t) {
    ...
    return (
      ...
      t.type !== "css-atrule" && typeof ((s = t.raws) == null ? void 0 : s.between) == "string" && (e += t.raws.between.length),
      e
    );
  }
  function vn(t) {
...
...`,
  ...
  function Wl(t) {
    ...
    let { raw: s } = e;
    return { frontMatter: e, content: _(!1, s, /[^\n]/gu, " ") + t.slice(s.length) };
  }
  var Je = Wl;
  function In(t) {
...
`
  ...
  function It(t) {
    var e, s;
    return (
      t.type === "value-comma_group" && ((s = (e = t.groups) == null ? void 0 : e[1]) == null ? void 0 : s.type) === "value-colon"
    );
  }
  function jr(t) {
    var e;
  ...
  function Gl(t, e, s) {
    ...
    let { node: r } = t,
      ...
      i = t.grandparent,
      o = Ln(t),
      a = o && n.type === "value-value" && (o === "grid" || o.startsWith("grid-template")),
    ...
    for (let m = 0; m < r.groups.length; ++m) {
      ...
      if (g.type === "value-string" && g.quoted) {
        ...
        C !== -1 && me !== -1 ? (x = C > me) : C !== -1 ? (x = !0) : me !== -1 && (x = !1);
      }
      if (
        x ||
        Dt(g) ||
        Dt(v) ||
        (g.type === "value-atword" && (g.value === "" || g.value.endsWith("["))) ||
        (v.type === "value-word" && v.value.startsWith("]")) ||
        g.value === "~" ||
        (g.type !== "value-string" && g.value && g.value.includes("\\") && v && v.type !== "value-comment") ||
        (b != null &&
          b.value &&
      ...
      if (
        ...
        continue;
      let $ = (Q(g) || le(g)) && m === 0 && (v.type === "value-number" || v.isHex) && i && ei(i) && !ce(v),
        T = (R == null ? void 0 : R.type) === "value-func" || (R && et(R)) || g.type === "value-func" || et(g),
        O = v.type === "value-func" || et(v) || (b == null ? void 0 : b.type) === "value-func" || (b && et(b));
      ...
      if (
        !(
          ...
          !ke(t, "calc") &&
          !$ &&
          ((Xe(v) && !T) || (Xe(g) && !O) || (Q(v) && !T) || (Q(g) && !O) || le(v) || le(g)) &&
          (ce(v) || (F && (!b || (b && Pt(b)))))
        ) &&
        !(
        ...
        if (a) {
          g.source && v.source && g.source.start.line !== v.source.start.line ? (l.push(E), (h = !0)) : l.push(" ");
          continue;
        }
        if (H) {
          l.push(" ");
  ...
  var ii = /(["'])(?:(?!\1)[^\\]|\\.)*\1/gsu,
    ...
    Kl = /[a-z]+/giu,
    Ql = /[$@]?[_a-z\u0080-\uFFFF][\w\u0080-\uFFFF-]*/giu,
    Jl = new RegExp(ii.source + `|(${Ql.source})?(${Hl.source})(${Kl.source})?`, "giu");
  function W(t, e) {
...
` ||
  ...
  var ui = ec;
  function tc(t, e) {
    return e === !1 ? !1 : t.charAt(e) === "/" && t.charAt(e + 1) === "/" ? At(t, e) : e;
  }
  var li = tc;
  function rc(t, e) {
    let s = null,
  ...
  function nc(t, e) {
    return $n(t.grandparent) && sc(t, e)
      ...
      : t.node.type !== "value-comment" &&
          !(t.node.type === "value-comma_group" && t.node.groups.every(s => s.type === "value-comment")) &&
          ai(e) &&
          t.callParent(() => Kr(t, e))
        ? Et(",")
        : "";
  ...
  function ci(t, e, s) {
    ...
    let o = t.map(({ node: w, isLast: x, index: h }) => {
      ...
      f = u || (c && !a),
      p = u || a,
      l = L([r.open ? s("open") : "", q([M, V(A, o)]), M, r.close ? s("close") : ""], { shouldBreak: f });
    return p ? ue(l) : l;
  }
  function es(t) {
    return t.match(
      e => e.type === "value-paren_group" && !e.open && e.groups.some(s => s.type === "value-comma_group"),
      (e, s) => s === "group" && e.type === "value-value",
      (e, s) => s === "group" && e.type === "value-root",
      (e, s) => s === "value" && ((e.type === "css-decl" && !e.prop.startsWith("--")) || (e.type === "css-atrule" && e.variable))
    );
  }
  function ic(t, e, s) {
    let r = [];
    return (
      t.each(() => {
        ...
        if (
          ...
          return;
        let { next: o } = t;
        (o.type === "css-comment" && !Bt(e.originalText, N(o), { backwards: !0 }) && !_e(n)) ||
        (o.type === "css-atrule" && o.name === "else" && n.type !== "css-comment")
          ? r.push(" ")
          : (r.push(e.__isHTMLStyleAttribute ? A : E), Ut(e.originalText, P(n)) && !_e(n) && r.push(E));
      }, "nodes"),
      r
    );
  }
    ...
    switch (r.type) {
      ...
      case "css-root": {
        ...
        return (
          ...
          [r.frontMatter ? [s("frontMatter"), E] : "", f, p ? ` ${p}` : "", r.nodes.length > 0 ? E : ""]
        );
      }
      case "css-comment": {
      ...
      case "css-rule":
        return [
          ...
          r.nodes
            ? [
                ((n = r.selector) == null ? void 0 : n.type) === "selector-unknown" && Se(r.selector.value)
                  ? A
                  : r.selector
                    ? " "
                    : "",
        ...
        if (e.parser === "less") {
          ...
          if (r.variable)
            return [
              ...
              r.nodes ? ["{", q([r.nodes.length > 0 ? M : "", Te(t, e, s)]), M, "}"] : "",
              p ? "" : ";"
            ];
        }
        let l =
          r.name === "import" && ((a = r.params) == null ? void 0 : a.type) === "value-unknown" && r.params.value.endsWith(";");
        return [
          "@",
          ...
          r.value ? L([" ", s("value"), Ze(r, e) ? (Jn(r) ? " " : A) : ""]) : r.name === "else" ? " " : "",
          r.nodes
            ? [
                Ze(r, e)
                  ? ""
                  : (r.selector && !r.selector.nodes && typeof r.selector.value == "string" && Se(r.selector.value)) ||
                      (!r.selector && typeof r.params == "string" && Se(r.params))
                    ? A
                    : " ",
                "{",
      ...
      case "media-keyword":
        return W(r.value, e);
      case "media-url":
        return W(_(!1, _(!1, r.value, /^url\(\s+/giu, "url("), /\s+\)$/gu, ")"), e);
      case "media-unknown":
        return r.value;
      case "selector-root":
        return L([
          Ee(t, "custom-selector") ? [t.findAncestor(f => f.type === "css-atrule").customSelector, A] : "",
          V([",", Ee(t, ["extend", "custom-selector", "nest"]) ? A : E], t.map(s, "nodes"))
        ]);
  ...
  var ac = { print: oc, embed: pn, insertPragma: qn, massageAstNode: ln, getVisitorKeys: mn },
    fi = ac;
  var pi = [
    {
  ...
  function J(t, e, s) {
    if (t && typeof t == "object") {
      ...
      for (let r in t)
        (J(t[r], e, s),
          r === "type" && typeof t[r] == "string" && !t[r].startsWith(e) && (!s || !s.test(t[r])) && (t[r] = e + t[r]));
    }
    return t;
  }
  function Is(t) {
  ...
  function fy(t) {
    if (ee(t)) {
      for (let e = t.length - 1; e > 0; e--)
        if (t[e].type === "word" && t[e].value === "{" && t[e - 1].type === "word" && t[e - 1].value.endsWith("#")) return !0;
    }
    return !1;
  }
  var ju = fy;
  ...
  function dy(t, e) {
    ...
    for (let c = 0; c < s.length; ++c) {
      ...
      if (
        ...
        f.type === "func" &&
          f.value === "selector" &&
          (f.group.groups = [Z(Br(t).text.slice(f.group.open.sourceIndex + 1, f.group.close.sourceIndex))]),
      ...
      if (f.type === "paren" && f.value === "(")
        ...
        f.type === "comma"
          ? (r.groups.push(o), (o = { groups: [], type: "comma_group" }), (a[a.length - 1] = o))
          : o.groups.push(f);
    }
  ...
  function Ju(t, e) {
    if (t && typeof t == "object")
      for (let s in t) s !== "parent" && (Ju(t[s], e), s === "nodes" && ((t.group = Ur(dy(t, e))), delete t[s]));
    return t;
  }
  function my(t, e) {
  ...
  function sl(t, e) {
    ...
    if (t && typeof t == "object") {
      ...
      if (
        ...
        if (t.value.trimEnd().endsWith("}")) {
          let u = e.originalText.slice(0, t.source.start.offset),
            c = "a".repeat(t.prop.length) + e.originalText.slice(t.source.start.offset + t.prop.length, t.source.end.offset),
            f = _(!1, u, /[^\n]/gu, " ") + c,
            p;
        ...
        return (
          a ? (t.value = { type: "css-rule", nodes: a }) : (t.value = { type: "value-unknown", value: t.raws.value.raw }),
          t
        );
      }
      let n = "";
      ...
      let i = "";
      typeof t.value == "string" &&
        ((i = t.raws.value ? (t.raws.value.scss ?? t.raws.value.raw) : t.value), (i = i.trim()), (t.raws.value = i));
      let o = "";
      if (
        ...
        return n.startsWith("@") && n.endsWith(":")
          ...
          : t.mixin
            ? ((t.selector = ie(n, e)), t)
            : (Zu(t, e) && (t.isSCSSNesterProperty = !0), (t.selector = Z(n)), t);
      if (i.length > 0) {
        let a = i.match(vy);
        a && ((i = i.slice(0, a.index)), (t.scssDefault = !0), a[0].trim() !== "!default" && (t.raws.scssDefault = a[0]));
        let u = i.match(xy);
        if (
          (u && ((i = i.slice(0, u.index)), (t.scssGlobal = !0), u[0].trim() !== "!global" && (t.raws.scssGlobal = u[0])),
          i.startsWith("progid:"))
        )
      ...
      if (
        (e.parser === "less" &&
          ...
          t.extend && !t.selector && (delete t.value, (t.selector = Z(i.slice(7, -1))))),
        t.type === "css-atrule")
      ) {
        if (e.parser === "less") {
          if (t.mixin) {
      ...
      if (t.type === "css-atrule" && o.length > 0) {
        ...
        return a === "warn" || a === "error"
          ...
          : a === "extend" || a === "nest"
            ...
            : a === "at-root"
              ? (/^\(\s*(?:without|with)\s*:.+\)$/su.test(o) ? (t.params = ie(o, e)) : ((t.selector = Z(o)), delete t.params), t)
              : Xu(u)
