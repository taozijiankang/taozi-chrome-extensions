(function (f) {
  ...
  var Jr = (t, e) => {
      for (var r in e) lr(t, r, { get: e[r], enumerable: !0 });
    },
    ai = (t, e, r, n) => {
      if ((e && typeof e == "object") || typeof e == "function")
        for (let s of si(e))
          !ii.call(t, s) && s !== r && lr(t, s, { get: () => e[s], enumerable: !(n = ni(e, s)) || n.enumerable });
      return t;
    };
  var oi = t => ai(lr({}, "__esModule", { value: !0 }), t);
  var Zr = (t, e, r) => e.has(t) || Xr("Cannot " + r);
  var Q = (t, e, r) => (Zr(t, e, "read from private field"), r ? r.call(t) : e.get(t)),
    en = (t, e, r) =>
      e.has(t) ? Xr("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, r),
    tn = (t, e, r, n) => (Zr(t, e, "write to private field"), n ? n.call(t, r) : e.set(t, r), r);
  var Vo = {};
...
Expected it to be ${n}.`;
  ...
  var ne = { type: de };
  var hi = { type: Y, hard: !0 },
    mi = { type: Y, hard: !0, literal: !0 },
    E = { type: Y },
    v = { type: Y, soft: !0 },
    S = [hi, ne],
    un = [mi, ne];
...
`,
  ...
  var Ei = new Set([
    ...
    Ai = new Set(["if", "else if", "for", "switch", "case"]);
  function fn(t, e) {
    var r;
    ...
    if (
      ...
      for (let n of e.parameters.children) Ai.has(t.name) ? delete n.expression : (n.expression = n.expression.trim());
  ...
  function j(t, e) {
    let r =
      t.type === "NGRoot"
        ? t.node.type === "NGMicrosyntax" && t.node.body.length === 1 && t.node.body[0].type === "NGMicrosyntaxExpression"
  ...
  function vi(t, e, r, n) {
    ...
    return /^\s*$/u.test(i) ? "" : T(i, t, { parser: "__ng_directive", __isInHtmlAttribute: !1 }, j);
  }
  var Cn = vi;
  ...
  function bi(t, e) {
    let r = t.plugins.flatMap(s => s.languages ?? []),
      n = wi(r, e.language) ?? Sn(r, e.physicalFile) ?? Sn(r, e.file) ?? (e.physicalFile, void 0);
  ...
  function yt(t, e) {
    return !!(
      (t.type === "ieConditionalComment" && t.lastChild && !t.lastChild.isSelfClosing && !t.lastChild.endSourceSpan) ||
      (t.type === "ieConditionalComment" && !t.complete) ||
      (_e(t) && t.children.some(r => r.type !== "text" && r.type !== "interpolation")) ||
      (Tt(t, e) && !U(t) && t.type !== "interpolation")
    );
  }
  function Ee(t) {
    return t.type === "attribute" || !t.parent || !t.prev ? !1 : ki(t.prev);
  }
  function ki(t) {
  ...
  function bn(t, e) {
    var s, i;
    let r = n();
    if (r && !t.prev && (i = (s = t.parent) == null ? void 0 : s.tagDefinition) != null && i.ignoreFirstLf)
              ...
              : !(
                  (!t.prev &&
                    (t.parent.type === "root" ||
                      ...
                      U(t.parent) ||
                      Je(t.parent, e) ||
                      !Ii(t.parent.cssDisplay))) ||
                  (t.prev && !Oi(t.prev.cssDisplay))
                );
    }
  }
  function Tn(t, e) {
    return $e(t) || t.type === "angularControlFlowBlock"
      ? !1
      : (t.type === "text" || t.type === "interpolation") && t.next && (t.next.type === "text" || t.next.type === "interpolation")
        ? !0
        : !t.parent || t.parent.cssDisplay === "none"
          ? !1
          : _e(t.parent)
            ...
            : !(
                (!t.next &&
                  (t.parent.type === "root" ||
                    ...
                    U(t.parent) ||
                    Je(t.parent, e) ||
                    !Ri(t.parent.cssDisplay))) ||
                (t.next && !$i(t.next.cssDisplay))
              );
  }
  function xn(t) {
  ...
  function kn(t) {
    return (
      ...
      (t.type === "element" &&
        t.children.length > 0 &&
        (["body", "script", "style"].includes(t.name) || t.children.some(e => Li(e)))) ||
      (t.firstChild &&
  ...
  function Fn(t) {
    return (
      ...
      (t.next
        ...
        : t.parent.type === "root" || (t.parent.endSourceSpan && t.parent.endSourceSpan.start.line > t.sourceSpan.end.line))
    );
  }
  function Nn(t) {
    switch (t.type) {
  ...
  function In(t, e) {
    ...
    if (t.type === "element" && t.namespace === "svg")
      if (qi(t, s => s.fullName === "svg:foreignObject")) r = !0;
...
`);
  ...
  var Vi = new Set(["template", "style", "script"]);
  function Je(t, e) {
  ...
  async function Mn(t, e) {
    let r = [];
    for (let [n, s] of t.split(Er).entries())
      if (n % 2 === 0) r.push(B(s));
      else
        try {
          r.push(_(["{{", k([E, await T(s, e, { parser: "__ng_interpolation", __isInHtmlInterpolation: !0 })]), E, "}}"]));
        } catch {
          r.push("{{", B(s), "}}");
        }
    return r;
  ...
  var Ui = Ar({ parser: "__ng_action" }),
    Wi = Ar({ parser: "__ng_binding" }),
    zi = Ar({ parser: "__ng_directive" });
  function Gi(t, e) {
...
` ||
  ...
  function ra(t) {
    let e = Wn(t),
      r = ta.filter(l => e.some(f => Object.prototype.hasOwnProperty.call(f, l)));
  ...
  function Yn(t, e) {
    ...
    if (r.fullName === "style" && !e.parentParser && !n.includes("{{"))
      return async s => Ce(await s(n, { parser: "css", __isHTMLStyleAttribute: !0 }));
  }
  var Dr = new WeakMap();
  function na(t, e) {
    let { root: r } = t;
  ...
  function jn(t, e, r) {
    let { node: n } = r,
      s = P(n);
    return T(`type T<${s}> = any`, t, { parser: "babel-ts", __isEmbeddedTypescriptGenericParameters: !0 }, j);
  }
  ...
  function Qn(t) {
    let e = /^(?:[\w$]+|\([^)]*\))\s*=>|^function\s*\(/u,
      r = /^[$_a-z][\w$]*(?:\.[$_a-z][\w$]*|\['[^']*'\]|\["[^"]*"\]|\[\d+\]|\[[$_a-z][\w$]*\])*$/iu,
      n = t.trim();
    return e.test(n) || r.test(n);
  }
  async function Xn(t, e, r, n) {
    let s = P(r.node),
      { left: i, operator: a, right: o } = sa(s),
      u = Me(r, n);
    return [
      _(await T(`function _(${i}) {}`, t, { parser: u ? "babel-ts" : "babel", __isVueForBindingLeft: !0 })),
      " ",
      a,
      " ",
  ...
  function la(t) {
    return async (e, r, n, s) => {
      ...
      if (i) return ((i = Dt(i, a => (typeof a == "string" ? w(!1, a, '"', "&quot;") : a))), [n.node.rawName, '="', _(i), '"']);
    };
  }
  var es = ua;
  ...
  function fa(t, e, r) {
    ...
    let s = ((f = n.prev) == null ? void 0 : f.type) === "comment" && ma(n.prev.value),
      i = typeof s == "boolean" ? () => s : Array.isArray(s) ? d => s.includes(d.rawName) : () => !1,
      a = t.map(({ node: d }) => (i(d) ? B(e.originalText.slice(se(d), ie(d))) : r()), "attrs"),
      o =
        n.type === "element" &&
        n.fullName === "script" &&
        n.attrs.length === 1 &&
    ...
    return (
      (n.firstChild && tt(n.firstChild)) || (n.isSelfClosing && ye(n.parent)) || o
        ...
        : l.push(e.bracketSameLine ? (n.isSelfClosing ? " " : "") : n.isSelfClosing ? E : v),
      l
    );
  }
  function da(t) {
  ...
  function ga(t, e) {
    ...
    return (
      t.lastChild && we(t.lastChild) ? (n += Bt(t, e).length) : ye(t) && (n -= ve(t.lastChild, e).length),
      e.originalText.slice(r, n)
    );
  }
  var Nt = ga;
  var Ca = new Set(["if", "else if", "for", "switch", "case"]);
  function Sa(t, e) {
    let { node: r } = t;
    switch (r.type) {
      case "element":
          ...
          return n
            ? async (s, i) => {
                let a = Nt(r, e),
                  ...
                  u = "";
                return (
                  o || ((u = await s(fr(a), { parser: n, __embeddedInHtml: !0 })), (o = u === "")),
                  [z(r, e), _(rt(t, e, i)), o ? "" : S, u, o ? "" : S, Ze(r, e), W(r, e)]
                );
              }
            : void 0;
        }
          ...
          return async n => {
            ...
            return (
              e.parser === "angular"
                ...
                : e.parser === "vue"
                  ? (s.parser = Me(t, e) ? "__vue_ts_expression" : "__vue_expression")
                  : (s.parser = "__js_expression"),
              [k([E, await n(r.value, s)]), r.parent.next && K(r.parent.next) ? " " : E]
            );
          };
        break;
      case "attribute":
...
` + t
  ...
  function cs(t) {
    let e = ie(t);
    return t.type === "element" && !t.endSourceSpan && qe(t.children) ? Math.max(e, cs(X(!1, t.children, -1))) : e;
  }
  function it(t, e, r) {
    let n = t.node;
    if (Ee(n)) {
    ...
    return $(t) && $(e)
      ? t.isTrailingSpaceSensitive
        ...
        : wt(e)
          ? S
          : v
      : (et(t) && (Ee(e) || e.firstChild || e.isSelfClosing || (e.type === "element" && e.attrs.length > 0))) ||
          (t.type === "element" && t.isSelfClosing && K(e))
        ? ""
        : !e.isLeadingSpaceSensitive ||
            wt(e) ||
            (K(e) && t.lastChild && we(t.lastChild) && t.lastChild.lastChild && we(t.lastChild.lastChild))
          ? S
          : e.hasLeadingSpaces
            ? E
            : v;
  ...
  function He(t, e, r) {
    ...
    return t.map((i, a) => {
      ...
      return (
        d && (Qe(o.prev) ? u.push(S, S) : d === S ? u.push(S) : $(o.prev) ? p.push(d) : p.push(ge("", v, { groupId: s[a - 1] }))),
        C && (Qe(o) ? $(o.next) && f.push(S, S) : C === S ? $(o.next) && f.push(S) : l.push(C)),
  ...
  function fs(t, e, r) {
    ...
    return [
      be(n, e),
      _([n.switchValue.trim(), ", ", n.clause, n.cases.length > 0 ? [",", k([E, q(E, t.map(r, "cases"))])] : "", v]),
      De(n, e)
    ];
  }
  function ds(t, e, r) {
    ...
    return [
      n.value,
      " {",
      _([k([v, t.map(({ node: s }) => (s.type === "text" && !N.trim(s.value) ? "" : r()), "expression")]), v]),
      "}"
    ];
  }
  function gs(t, e, r) {
    ...
    let s =
      ...
      o = l =>
        s
          ? on(l, { groupId: i })
          : (U(n) || Je(n, e)) && n.parent.type === "root" && e.parser === "vue" && !e.vueIndentScriptAndStyle
            ? l
            : k(l),
      u = () =>
        s
          ...
          : s
            ...
            : n.lastChild.hasTrailingSpaces && n.lastChild.isTrailingSpaceSensitive
              ...
              : (n.lastChild.type === "comment" ||
                  ...
                  new RegExp(`\\n[\\t ]{${e.tabWidth * (t.ancestors.length - 1)}}$`, "u").test(n.lastChild.value)
                ? ""
                : v;
...
`
    ...
    t.walk(n => {
      if (n.children)
        for (let s = 0; s < n.children.length; s++) {
          ...
          !a ||
            a.type !== "text" ||
            ((a.value += i.value), (a.sourceSpan = new h(a.sourceSpan.start, i.sourceSpan.end)), n.removeChild(i), s--);
        }
    });
  }
  function Ba(t) {
      ...
      if (yn(n))
        for (let s of n.children) {
          ...
          for (let u = 0; u < o.length; u++, i = a) {
            ...
            if (u % 2 === 0) {
              ((a = i.moveBy(p.length)),
                p.length > 0 && n.insertChildBefore(s, { type: "text", value: p, sourceSpan: new h(i, a) }));
              continue;
            }
            ((a = i.moveBy(p.length + 4)),
              n.insertChildBefore(s, {
                ...
                children: p.length === 0 ? [] : [{ type: "text", value: p, sourceSpan: new h(i.moveBy(2), a.moveBy(-2)) }]
              }));
          }
          n.removeChild(s);
        }
  ...
  function Na(t) {
    t.walk(e => {
      ...
      if (
        e.children.length === 0 ||
        (e.children.length === 1 && e.children[0].type === "text" && N.trim(e.children[0].value).length === 0)
      ) {
      ...
      if (!r)
        for (let s = 0; s < e.children.length; s++) {
          ...
          let { leadingWhitespace: a, text: o, trailingWhitespace: u } = vn(i.value),
            p = i.prev,
            l = i.next;
          o
            ? ((i.value = o),
              (i.sourceSpan = new h(i.sourceSpan.start.moveBy(a.length), i.sourceSpan.end.moveBy(-u.length))),
    ...
    t.walk(r => {
      r.type === "element" &&
        (r.hasHtmComponentClosingTag =
          r.endSourceSpan &&
          /^<\s*\/\s*\/\s*>$/u.test(e.originalText.slice(r.endSourceSpan.start.offset, r.endSourceSpan.end.offset)));
    });
  }
  function Ra(t, e) {
    t.walk(r => {
  ...
  function Oa(t, e, r) {
    ...
    switch (n.type) {
      ...
      case "docType":
        return [_([be(n, e), " ", w(!1, n.value.replace(/^html\b/iu, "html"), /\s+/gu, " ")]), De(n, e)];
      case "comment":
      ...
      case "attribute": {
        ...
        let s = _r(n.value),
          i = pn(s, '"');
        return [n.rawName, "=", i, B(i === '"' ? w(!1, s, '"', "&quot;") : w(!1, s, "'", "&apos;")), i];
      }
      case "cdata":
      default:
        throw new mn(n, "HTML");
  ...
  var Ma = { preprocess: Es, print: Oa, insertPragma: us, massageAstNode: dn, embed: ns, getVisitorKeys: as },
    As = Ma;
  var Ds = [
    {
  ...
  var Ha = "boolean",
    ...
    Ga = Array.from(ks).reduce((t, [e, r]) => (t.set(e, r), t), new Map()),
    Vt = class extends Ht {
      constructor() {
        (super(),
      ...
      hasProperty(e, r, n) {
        if (n.some(i => i.name === xr.name)) return !0;
        if (e.indexOf("-") > -1) {
          if (kr(e) || Br(e)) return !1;
          if (n.some(i => i.name === Tr.name)) return !0;
        }
        return (this._schema.get(e.toLowerCase()) || this._schema.get("unknown")).has(r);
      }
      hasElement(e, r) {
        return r.some(n => n.name === xr.name) || (e.indexOf("-") > -1 && (kr(e) || Br(e) || r.some(n => n.name === Tr.name)))
          ? !0
    ...
    return (
      lt ||
        ...
        (lt = Object.assign(Object.create(null), {
          ...
          title: new m({ contentType: { default: I.ESCAPABLE_RAW_TEXT, svg: I.PARSABLE_DATA } }),
          textarea: new m({ contentType: I.ESCAPABLE_RAW_TEXT, ignoreFirstLf: !0 })
        })),
    ...
    Mr = class {
      constructor(e, r, n) {
        ((this._getTagContentType = r),
          ...
          (this._interpolationConfig = n.interpolationConfig || Nr),
        ...
        ((this._cursor = n.escapedString ? new qr(e, s) : new rr(e, s)),
...
`
        ...
        for (; this._cursor.peek() !== 0; ) {
          ...
          try {
            if (this._attemptCharCode(60))
              ...
              this._tokenizeLet && this._cursor.peek() === 64 && !this._inInterpolation && this._attemptStr("@let")
      ...
      _getBlockName() {
        ...
        return (this._attemptCharCodeUntilFn(n => (at(n) ? !e : Ms(n) ? ((e = !0), !1) : !0)), this._cursor.getChars(r).trim());
      }
      _consumeBlockStart(e) {
        ...
        if (this._cursor.peek() === 40)
          if (
            (this._cursor.advance(), this._consumeBlockParameters(), this._attemptCharCodeUntilFn(b), this._attemptCharCode(41))
          )
      ...
      _getLetDeclarationName() {
        let e = this._cursor.clone(),
          r = !1;
        return (
          this._attemptCharCodeUntilFn(n => (ot(n) || n == 36 || n === 95 || (r && It(n)) ? ((r = !0), !1) : !0)),
      ...
      _consumeLetDeclarationValue() {
        ...
        for (this._beginToken(31, e); this._cursor.peek() !== 0; ) {
          ...
          if (r === 59) break;
          ($t(r) &&
            (this._cursor.advance(), this._attemptCharCodeUntilFn(n => (n === 92 ? (this._cursor.advance(), !1) : n === r))),
            this._cursor.advance());
        }
      ...
      _tokenizeExpansionForm() {
        ...
        if (Ao(this._cursor.peek()) && this._isInExpansionForm()) return (this._consumeExpansionCaseStart(), !0);
      ...
      handleError(e) {
        if ((e instanceof gt && (e = this._createError(e.msg, this._cursor.getSpan(e.cursor))), e instanceof dt))
      ...
      _attemptCharCodeCaseInsensitive(e) {
        return Do(this._cursor.peek(), e) ? (this._cursor.advance(), !0) : !1;
      }
      _requireCharCode(e) {
        let r = this._cursor.clone();
      ...
      _requireCharCodeUntilFn(e, r) {
        ...
        if ((this._attemptCharCodeUntilFn(e), this._cursor.diff(n) < r))
          throw this._createError(je(this._cursor.peek()), this._cursor.getSpan(n));
      }
      _attemptUntilChar(e) {
      ...
      _consumeEntity(e) {
        ...
        if ((this._cursor.advance(), this._attemptCharCode(35))) {
          ...
          let n = this._cursor.clone();
          if ((this._attemptCharCodeUntilFn(Eo), this._cursor.peek() != 59))
      ...
      _consumeTagOpen(e) {
        ...
        try {
          ...
          for (
            s = this._consumeTagOpenStart(e), n = s.parts[0], r = s.parts[1], this._attemptCharCodeUntilFn(b);
        ...
        (this._handleFullNameStackForTagOpen(n, r),
          a === I.RAW_TEXT
            ...
            : a === I.ESCAPABLE_RAW_TEXT && this._consumeRawTextWithTagClose(n, r, !0));
      }
      ...
      _consumeInterpolation(e, r, n) {
        ...
        for (; this._cursor.peek() !== 0 && (n === null || !n()); ) {
          ...
          (this._cursor.advance(),
            p === 92 ? this._cursor.advance() : p === a ? (a = null) : !o && a === null && $t(p) && (a = p));
        }
    ...
    Wr = class t {
      ...
      build() {
        ...
        for (let e of this._containerStack)
          e instanceof Z && this.errors.push(L.create(e.name, e.sourceSpan, `Unclosed block "${e.name}"`));
      }
      _advance() {
        let e = this._peek;
      ...
      _consumeComment(e) {
        let r = this._advanceIf(7),
          ...
          i = n == null ? e.sourceSpan : new h(e.sourceSpan.start, n.sourceSpan.end, e.sourceSpan.fullStart);
...
`
      ...
      _consumeStartTag(e) {
        ...
        if (this._peek.type === 2) {
          ...
          this.canSelfClose ||
            ...
            C.isVoid ||
            this.errors.push(
              L.create(i, e.sourceSpan, `Only void, custom and foreign elements can be self closed "${e.parts[1]}"`)
            );
        ...
        (this._pushContainer(f, d instanceof G && this.getTagDefinition(d.name).isClosedByChild(f.name)),
          a
            ? this._popContainer(i, G, u)
            : e.type === 4 &&
              (this._popContainer(i, G, null), this.errors.push(L.create(i, u, `Opening tag "${i}" not terminated.`))));
      }
      _pushContainer(e, r) {
      ...
      _popContainer(e, r, n) {
        ...
        for (let i = this._containerStack.length - 1; i >= 0; i--) {
          ...
          if (We(a.name) ? a.name === e : (e == null || a.name.toLowerCase() === e.toLowerCase()) && a instanceof r)
            return (
              (a.endSourceSpan = n),
          ...
          (a instanceof Z || (a instanceof G && !this.getTagDefinition(a.name).closedByParent)) && (s = !0);
        }
        return !1;
      }
      _consumeAttr(e) {
      ...
      _getClosestParentElement() {
        for (let e = this._containerStack.length - 1; e > -1; e--)
          if (this._containerStack[e] instanceof G) return this._containerStack[e];
        return null;
      }
      _addToParent(e) {
...
...`,
  ...
  var ir = { attrs: !0, children: !0, cases: !0, expression: !0 },
    ...
    ar = class t {
      constructor(e = {}) {
        for (let r of new Set([...Ks, ...Object.keys(e)])) this.setProperty(r, e[r]);
      }
      setProperty(e, r) {
        if (this[e] !== r) {
  ...
  var ko = [
    ...
    { regex: /^\[if([^\]]*)\]><!$/u, parse: Lo },
    { regex: /^<!\s*\[endif\]$/u, parse: Fo }
  ];
  function Qs(t, e) {
    if (t.value)
      for (let { regex: r, parse: n } of ko) {
  ...
  function Lo(t, e, r) {
    let [, n] = r;
    return { type: "ieConditionalStartComment", condition: w(!1, n.trim(), /\s+/gu, " "), sourceSpan: t.sourceSpan };
  }
  function Fo(t) {
  ...
  var or = new Map([
    ...
    [
      "form",
      new Set(["accept", "accept-charset", "action", "autocomplete", "enctype", "method", "name", "novalidate", "target"])
    ],
  ...
  function No(t) {
    if (t.type === "block") {
      if (
        ((t.name = w(!1, t.name.toLowerCase(), /\s+/gu, " ").trim()), (t.type = "angularControlFlowBlock"), !qe(t.parameters))
      ) {
        delete t.parameters;
        return;
      }
  ...
  function Io(t) {
    ((t.type === "plural" || t.type === "select") && ((t.clause = t.type), (t.type = "angularIcuExpression")),
  ...
  function Zs(t, e, r) {
    ...
    if (n === "vue") {
      if (l.some(x => (x.type === "docType" && x.value === "html") || (x.type === "element" && x.name.toLowerCase() === "html")))
        return Zs(t, ti, r);
      let g,
        y = () => g ?? (g = Gr(t, { canSelfClose: s, allowHtmComponentClosingTags: o, isTagNameCaseSensitive: u })),
    ...
    let d = c => {
        ...
        switch (c.type) {
          case "element":
            ...
            for (let g of c.attrs)
              (d(g),
                g.valueSpan
                  ? ((g.value = g.valueSpan.toString()), /["']/u.test(g.value[0]) && (g.value = g.value.slice(1, -1)))
                  : (g.value = null));
            break;
          case "comment":
      ...
      D = c => {
        if (
          c.type === "element" &&
          (i &&
            (!c.namespace || c.namespace === c.tagDefinition.implicitNamespacePrefix || Se(c)) &&
  ...
  function ei(t, e, r = {}, n = !0) {
    let { frontMatter: s, content: i } = n ? js(t) : { frontMatter: null, content: t },
    ...
    let l = new ar(p),
      f = (d, C) => {
        ...
        return (
          c.length === A
            ? F.children.shift()
            : ((c.sourceSpan = new h(c.sourceSpan.start.moveBy(A), c.sourceSpan.end)), (c.value = c.value.slice(A))),
          F
        );
      };
    return (
  ...
  var ti = { name: "html", normalizeTagName: !0, normalizeAttributeName: !0, allowHtmComponentClosingTags: !0 },
    $o = ur(ti),
    Oo = ur({ name: "angular" }),
    Mo = ur({
      name: "vue",
      ...
      shouldParseAsRawText(t, e, r, n) {
        return (
          t.toLowerCase() !== "html" &&
          !r &&
          (t !== "template" || n.some(({ name: s, value: i }) => s === "lang" && i !== "html" && i !== "" && i !== void 0))
        );
      }
    }),
    qo = ur({ name: "lwc", canSelfClose: !1 });
  var Ho = { html: As };
  return oi(Vo);
});
