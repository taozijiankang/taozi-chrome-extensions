  ...
  var At = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports),
    ...
    sr = (e, t, r, n) => {
      if ((t && typeof t == "object") || typeof t == "function")
        for (let i of Bu(t))
          !_u.call(e, i) && i !== r && He(e, i, { get: () => t[i], enumerable: !(n = Au(t, i)) || n.enumerable });
      return e;
    };
  var Me = (e, t, r) => (
      (r = e != null ? yu(wu(e)) : {}),
      sr(t || !e || !e.__esModule ? He(r, "default", { value: e, enumerable: !0 }) : r, e)
    ),
    ar = e => sr(He({}, "__esModule", { value: !0 }), e);
  var vu = (e, t, r) => t.has(e) || or("Cannot " + r);
  var Dr = (e, t, r) =>
    t.has(e) ? or("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r);
  ...
  Z.prototype = {
    diff: function (t, r) {
      ...
      function A() {
        for (var h = Math.max(m, -l); h <= Math.min(E, l); h += 2) {
          ...
          if (
            (!yt || ($ && k.oldPos + 1 < v.oldPos) ? (C = o.addToPath(v, !0, void 0, 0)) : (C = o.addToPath(k, void 0, !0, 1)),
    ...
    addToPath: function (t, r, n, i) {
      ...
      return u && u.added === r && u.removed === n
        ? {
            oldPos: t.oldPos + i,
            lastComponent: { count: u.count + 1, added: r, removed: n, previousComponent: u.previousComponent }
          }
        : { oldPos: t.oldPos + i, lastComponent: { count: 1, added: r, removed: n, previousComponent: u } };
    },
...
`
  ...
  function Bt(e, t, r, n, i) {
    ...
    if (Tu.call(e) === "[object Array]") {
      for (t.push(e), o = new Array(e.length), r.push(o), u = 0; u < e.length; u += 1) o[u] = Bt(e[u], t, r, n, i);
    ...
    if ((e && e.toJSON && (e = e.toJSON()), $e(e) === "object" && e !== null)) {
      ...
      for (s.sort(), u = 0; u < s.length; u += 1) ((a = s[u]), (o[a] = Bt(e[a], t, r, n, a)));
      (t.pop(), r.pop());
    } else o = e;
    return o;
  }
...
`
  ...
  var G = ku;
  var Lu = e => new Intl.ListFormat("en-US", { type: "disjunction" }).format(e);
  function Pu(e) {
...
Expected it to be ${n}.`;
  ...
  function ee(e) {
    ...
    return e.type === x
      ...
      : e.type === _
        ? { ...e, contents: ee(e.contents), expandedStates: (t = e.expandedStates) == null ? void 0 : t.map(ee) }
        : e.type === S
    ...
    function n(u, o, s) {
      ...
      if (u.type === x)
        return (
          ...
          (u.groupId ? (u.flatContents ? "" : ', ""') + `, { groupId: ${i(u.groupId)} }` : "") +
          ")"
        );
      if (u.type === R) {
        let l = [];
  ...
  function Hu(e) {
    if ((e.type === _ && e.break) || (e.type === B && e.hard) || e.type === b) return !0;
  }
  function Ir(e) {
    return Xe(e, Hu, !1);
  }
  ...
  function Pr(e) {
    for (e = [...e]; e.length >= 2 && y(!1, e, -2).type === B && y(!1, e, -1).type === b; ) e.length -= 2;
    if (e.length > 0) {
      let t = Se(y(!1, e, -1));
      e[e.length - 1] = t;
    }
    ...
    switch (G(e)) {
      ...
      case W: {
        ...
        for (let r of e) {
          ...
          (typeof n == "string" && typeof y(!1, t, -1) == "string" ? (t[t.length - 1] += n) : t.push(n), t.push(...i));
        }
    ...
    return t === Number.NEGATIVE_INFINITY
      ...
      : t < 0
        ...
        : t
          ? t.type === "root"
            ? { ...e, root: e }
            : bt(e, { type: typeof t == "string" ? "stringAlign" : "numberAlign", n: t }, r)
          : e;
  }
  function bt(e, t, r) {
...
` ||
  ...
  function Lt(e, t) {
    ((e.comments ?? (e.comments = [])).push(t), (t.printed = !1), (t.nodeDescription = ei(e)));
  }
  function ue(e, t) {
  ...
  function ut(e, t) {
    ...
    let {
      printer: { getCommentChildNodes: r, canAttachComment: n, getVisitorKeys: i },
      locStart: u,
      locEnd: o
    } = t;
    if (!n) return [];
  ...
  function Jr(e, t) {
    ...
    let n = [],
      ...
      f = r.map((p, c) => ({ ...qr(e, p, t), comment: p, text: a, options: t, ast: e, isLastComment: r.length - 1 === c }));
    for (let [p, c] of f.entries()) {
      ...
      let v;
      if (
        (o ? (v = [c]) : ((F.enclosingNode = E), (F.precedingNode = m), (F.followingNode = A), (v = [F, w, h, C, k])),
        ti(w, h, f, p))
      )
        ((F.placement = "ownLine"), D(...v) || (A ? ue(A, F) : m ? ie(m, F) : E ? re(E, F) : re(C, F)));
      else if (ri(w, h, f, p)) ((F.placement = "endOfLine"), l(...v) || (m ? ie(m, F) : A ? ue(A, F) : E ? re(E, F) : re(C, F)));
    ...
    if ((Kr(n, t), !o)) for (let p of r) (delete p.precedingNode, delete p.enclosingNode, delete p.followingNode);
  }
  var Xr = e => !/[\S\n\u2028\u2029]/u.test(e);
  function ti(e, t, r, n) {
  ...
  function Kr(e, t) {
    ...
    for (let D of [n, i]) D.comments && D.comments.length > 1 && D.comments.sort((l, d) => t.locStart(l) - t.locStart(d));
    e.length = 0;
  }
  function Rt(e, t, r) {
  ...
  function ni(e, t) {
    let r = t - 1;
    ((r = T(e, r, { backwards: !0 })), (r = M(e, r, { backwards: !0 })), (r = T(e, r, { backwards: !0 })));
  ...
  function ii(e, t, r) {
    ...
    if ((r != null && r.hasLineSuffix && !(r != null && r.isBlock)) || V(o, s(n), { backwards: !0 })) {
      let l = Le(o, s(n));
...
in order for it to be formatted.`,
  ...
  function Di(e) {
    ...
    for (let [r, n] of Object.entries(e)) {
      let i = { name: r, ...n };
      (Array.isArray(i.default) && (i.default = y(!1, i.default, -1).value), t.push(i));
    }
    return t;
  }
  ...
  function nn(e, t) {
    ...
    return (
      e.find(({ filenames: n }) => (n == null ? void 0 : n.some(i => i.toLowerCase() === r))) ??
      e.find(({ extensions: n }) => (n == null ? void 0 : n.some(i => r.endsWith(i))))
    );
  }
  function ci(e, t) {
    if (t)
  ...
  function fi(e, t) {
    let r = e.plugins.flatMap(i => i.languages ?? []),
      n = ci(r, t.language) ?? nn(r, t.physicalFile) ?? nn(r, t.file) ?? (t.physicalFile, void 0);
  ...
  var Yt = Me(ot(), 1),
    an = (e, t, { descriptor: r }) => {
      ...
      return (
        t && n.push(`we now treat it as ${Yt.default.blue(typeof t == "string" ? r.key(t) : r.pair(t))}`),
        n.join("; ") + "."
      );
    };
  var le = Me(ot(), 1);
  ...
  var Dn = " ".repeat(2),
    cn = (e, t, r) => {
      ...
      return (
        ...
        i &&
          u.push(
            [ln(e, t, i.title, r.descriptor)].concat(i.values.map(o => fn(o, r.loggerPrintWidth))).join(`
`)
          ),
  ...
  function fn({ text: e, list: t }, r) {
    ...
    return (
      ...
      t &&
        n.push(
          [`- ${le.default.blue(t.title)}:`].concat(t.values.map(i => fn(i, r - Dn.length).replace(/^|\n/g, `$&${Dn}`))).join(`
`)
        ),
      pn(n, r)
    );
...
`,
  ...
  function Ht(e, t) {
    ...
    for (; d < i; )
      for (o = t.charCodeAt(u + d), a = d++, s = d, l = 0; l < n; l++)
        ((D = o === dn[l] ? a : a + 1), (a = jt[l]), (s = jt[l] = a > s ? (D > s ? s + 1 : D) : D > a ? a + 1 : D));
    return s;
  }
  var at = (e, t, { descriptor: r, logger: n, schemas: i }) => {
    let u = [`Ignored unknown option ${Wt.default.yellow(r.pair({ key: e, value: t }))}.`],
      o = Object.keys(i)
        .sort()
        .find(s => Ht(e, s) < 3);
  ...
  function $t(e) {
    ...
    let { text: t, list: r } = e;
    return (
      mi((t || r) !== void 0, "Unexpected `expected` result, there should be at least one field."),
      r ? { text: t, list: { title: r.title, values: r.values.map($t) } } : { text: t }
    );
  }
  function Vt(e, t) {
  ...
  var Et = class {
      ...
      for (let o of i) {
        ...
        let D = ({ from: p, to: c }) => {
          ...
          l = ({ value: p, redirectTo: c }) => {
            ...
            if (F !== !1)
              if (F === !0) this._hasDeprecationWarned(o) || this._utils.logger.warn(this._deprecatedHandler(o, c, this._utils));
              else
    ...
    _applyRequiredCheck(t) {
      for (let r of Object.keys(this._utils.schemas))
        if (this._identifyMissing(r, t) && this._identifyRequired(r)) throw this._invalidHandler(r, st, this._utils);
    }
  ...
  function Ci(e, { isCLI: t, FlagSchema: r }) {
    ...
    for (let i of e)
      (n.push(gi(i, { isCLI: t, optionInfos: e, FlagSchema: r })),
        i.alias && t && n.push(Dt.create({ name: i.alias, sourceName: i.name })));
    return n;
  }
  function gi(e, { isCLI: t, optionInfos: r, FlagSchema: n }) {
    ...
    switch (e.type) {
      ...
      case "choice":
        ((o = dt),
          (u.choices = e.choices.map(a =>
            a != null && a.redirect ? { ...a, redirect: { to: { key: e.name, value: a.redirect } } } : a
          )));
        break;
      case "boolean":
        o = ft;
      ...
      case "flag":
        ((o = n),
          (u.flags = r.flatMap(a =>
            [a.alias, a.description && a.name, a.oppositeDescription && `no-${a.name}`].filter(Boolean)
          )));
        break;
      case "path":
        o = Re;
    ...
    if (
      ...
      e.redirect &&
        (s.redirect = a =>
          a ? { to: typeof e.redirect == "string" ? e.redirect : { key: e.redirect.option, value: e.redirect.value } } : void 0),
    ...
    return e.array
      ? ct.create({ ...(t ? { preprocess: a => (Array.isArray(a) ? a : [a]) } : {}), ...s, valueSchema: o.create(u) })
      : o.create({ ...u, ...s });
  }
  var bn = hi;
  var yi = (e, t, r) => {
  ...
  async function Ai(e, t = {}) {
    ...
    let n = it({ plugins: e.plugins, showDeprecated: !0 }).options,
      i = { ...Nn, ...Object.fromEntries(n.filter(f => f.default !== void 0).map(f => [f.name, f.default])) },
...
` + n),
  ...
  async function ki(e, t, r, n) {
    let i = await se({ ...r, ...t, parentParser: r.parser, originalText: e }, { passThrough: !0 }),
      { ast: u } = await ce(e, i),
      o = await n(u, i);
    return Ze(o);
  }
  ...
  function Gn(e, t, r, n, i) {
    ...
    let { node: u } = e,
      ...
      s;
    return (
      (a = o.hasPrettierIgnore) != null && a.call(o, e) ? (s = zn(e, t)) : i.has(u) ? (s = i.get(u)) : (s = o.print(e, t, r, n)),
  ...
  async function iu(e, t, r = 0) {
    ...
    if (r > 0) {
      ...
      (o.cursorNodeStart !== void 0 && (o.cursorNodeStart -= o.formatted.indexOf(a)), (o.formatted = a + Be(t.endOfLine)));
    }
      ...
      if (
        (t.cursorNode && o.cursorNodeText
          ? ((a = t.locStart(t.cursorNode)),
            ...
            (d = o.cursorNodeStart),
            (f = o.cursorNodeText))
          : ((a = 0), (D = i), (l = t.cursorOffset), (d = 0), (f = o.formatted)),
        D === f)
      )
...
`,
  ...
  function ou(e, t) {
    let { cursorOffset: r, rangeStart: n, rangeEnd: i, endOfLine: u } = ru(e, t),
      o = e.charAt(0) === uu;
    if ((o && ((e = e.slice(1)), r--, n--, i--), u === "auto" && (u = Fr(e)), e.includes("\r"))) {
      let s = a =>
        wt(
...
`
    ...
    return { hasBOM: o, text: e, options: ru(e, { ...t, cursorOffset: r, rangeStart: n, rangeEnd: i, endOfLine: u }) };
  }
  ...
  async function rr(e, t) {
    ...
    return (
      i.rangeStart > 0 || i.rangeEnd < n.length
        ? (u = await $i(n, i))
        : (!i.requirePragma && i.insertPragma && i.printer.insertPragma && !(await nu(n, i)) && (n = i.printer.insertPragma(n)),
          (u = await iu(n, i))),
      r && ((u.formatted = uu + u.formatted), u.cursorOffset >= 0 && u.cursorOffset++),
      u
    );
  }
  async function su(e, t, r) {
    let { text: n, options: i } = ou(e, await se(t)),
      u = await ce(n, i);
    return (r && (r.preprocessForPrint && (u.ast = await Qt(u.ast, i)), r.massage && (u.ast = qn(u.ast, i))), u);
  }
...
`
  ...
  var co = fe(it, 0),
    fo = { parse: fe(su), formatAST: fe(au), formatDoc: fe(Du), printToDoc: fe(lu), printDocToString: fe(cu) };
  return ar(po);
});
